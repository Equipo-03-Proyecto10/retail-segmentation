...
| F6-07 | #109 | Deliverable 13 — proof of deployment. [`evidence/f6-07-proof-of-deployment.md`](evidence/f6-07-proof-of-deployment.md) covers the unit's state and what is observable from outside; two acceptance criteria remain, both because they change the instance |
